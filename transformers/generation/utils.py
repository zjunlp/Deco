...
class SampleDecoderOnlyOutput(ModelOutput):
    ...
    attentions: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    hidden_states: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    final_probs: torch.FloatTensor = None
    last_layer_probs: torch.FloatTensor = None
    # premature_layer_dist: Optional[Dict[int, int]] = None
    ...
    def generate(
        ...
        **kwargs,
        ...
        if is_greedy_gen_mode and use_deco:
            ...
            return self.deco_greedy_search(
                input_ids,
                logits_processor=logits_processor,
                stopping_criteria=stopping_criteria,
                pad_token_id=generation_config.pad_token_id,
            ...
            return self.deco_sample_search(
                input_ids,
                logits_processor=logits_processor,
            ...
            # run deco beam search
            return self.deco_beam_search(
                input_ids=input_ids,

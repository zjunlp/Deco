...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        return BaseModelOutputWithPast(
            last_hidden_state=hidden_states, # last_hidden_states 为最后层输出的hidden_states = self.norm(hidden_states)
            past_key_values=next_cache,
            hidden_states=all_hidden_states, # hidden_states 为所有的 其中[0] = input_embeds,[...] = hidden_states  ,[-1] = norm(hidden_states[32])
